...
const financesSlice = createSlice({
  ...
  reducers: {
    ...
    deleteSpendings: (state, action) => state.spendings.filter(item => item.id !== action.payload),
    deleteIncomes: (state, action) => state.incomes.filter(item => item.id !== action.payload)
